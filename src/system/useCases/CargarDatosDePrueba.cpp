...
void Sistema::cargarDatosdePrueba()
{
    ...
    DTNotificacion *notificacion1 = new DTNotificacion("Introducción a la Programación", "Inglés");
    DTNotificacion *notificacion2 = new DTNotificacion("Diseño de Interfaz de Usuario", "Francés");
    DTNotificacion *notificacion3 = new DTNotificacion("Marketing Digital Avanzado", "Español");
    DTNotificacion *notificacion4 = new DTNotificacion("Análisis de Datos", "Alemán");

    // Imprimir las Notificaciones
    cout << "Notificacion 1: " << endl
         << *notificacion1 << endl;
    cout << "Notificacion 2: " << endl
         << *notificacion2 << endl;
    cout << "Notificacion 3: " << endl
         << *notificacion3 << endl;
    cout << "Notificacion 4: " << endl
         << *notificacion4 << endl;
